...
def run(config):
    ...
    for ep_i in tqdm(range(0, config.n_episodes, config.n_rollout_threads)):
        ...
        # Calculate and print Degree of Synchronization (DOS) and Degree of Alignment (DOA) metrics
        dos, doa = env.dos_and_doa_one_episode(
            p_store, h_store, N_p, M_p)
        # print(f"Degree of Synchronization (DOS): {dos}")
        # print(f"Degree of Alignment (DOA): {doa}")
...
if __name__ == '__main__':
    ...
    # TODO: add an argument to create a gif
    # TODO: add code to save DoS and DoA metrics during training
