...
class DDPGAgent(object):
    ...
    def __init__(self, num_in_pol, num_out_pol, num_in_critic, 
        ...
        self.target_policy = MLPNetwork(num_in_pol, num_out_pol,
                                        ...
                                        constrain_out=True,
                                        discrete_action=discrete_action)
        # self.target_policy = target_policy.clamp(-1,1)
    ...
    """
    previous step function, the above one is from Jianan's paper. Remember to change noise.exploration when switching.
